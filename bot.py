...
TELEGRAM_TOKEN = '8551296586:AAFX631OEnFIX0L1uVoc4Ysv3-KpTsqkqHA'
CHAT_ID = '1950462171'
...
async def fetch_indicators():
    try:
        ...
        # UPDATED: Changed from 15m to 5m
...
async def main():
    global active_trade
    logger.info("SYSTEM_BOOT: Bot Online. Strategy: RSI EMA (5m) via 1m Stream")
    
    # KEPT AS 1m PER REQUEST
